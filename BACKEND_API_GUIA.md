...
Guia para replicar el mismo backend de Cuantiva (gastos-app) en otro proyecto Next.js que hoy solo tiene datos mock. El objetivo es pasar de "datos fijos en el frontend" a **persistencia real en Postgres**, con autenticacion, servicios, y endpoints REST dentro de `app/api/`.
